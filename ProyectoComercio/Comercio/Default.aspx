    ...
    <div class="container text-center">
        <div class="row">
            <div class="col" style="width: 100px; height: 100px; border: 1px solid black; background-color: gray">
                <h4>Venta Del Día</h4>
                <asp:Label ID="lbVenta" runat="server" Text="00.0" style="font-size: 24px; "></asp:Label>
                
            </div>

            <div class="col" style="width: 100px; height: 100px; border: 1px solid black; background-color: gray">
                <h4>Gastos del Día</h4>
                <asp:Label ID="lbGasto" runat="server" Text="0.00" style="font-size: 24px;"></asp:Label>
                
            </div>
            <div class="col" style="width: 100px; height: 100px; border: 1px solid black; background-color: gray">
                <h4>Rendimiento del Día</h4>
                <asp:Label ID="lbRendimiento" runat="server" Text="0.00" style="font-size: 24px;"></asp:Label>
            </div>
        </div>
    </div>
    <%--Contenedor final tres cuadros  --%>

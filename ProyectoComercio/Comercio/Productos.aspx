                ...
                <div class="tab-pane fade show active" id="producto" role="tabpanel" aria-labelledby="producto-tab">
                    <div class="md-3 p-3 bg-primary bg-opacity-10 border border-4 border-primary-subtle rounded-4">
                        ...
                        <div class="table-container pb-4 border border-primary-subtle p-2 mb-2  rounded bg-primary bg-opacity-50">
                            ...
                            <asp:GridView runat="server" ID="dgvProducto" DataKeyNames="Id" OnSelectedIndexChanged="dgvProducto_SelectedIndexChanged" CssClass="table table-striped table-bordered table-hover table-primary table table-bordered border-primary" AutoGenerateColumns="false">
                                <Columns>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-3">
                                        ...
                                        <asp:GridView runat="server" ID="dgvCategoria" DataKeyNames="Id" CssClass="table table-striped table-bordered table-hover table-primary table table-bordered border-primary" AutoGenerateColumns="false">
                                            <Columns>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-3">
                                        ...
                                        <asp:GridView runat="server" ID="dgvMedida" DataKeyNames="Id" CssClass="table table-striped table-bordered table-hover table-primary table table-bordered border-primary" AutoGenerateColumns="false">
                                            <Columns>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-3">
                                        ...
                                        <asp:GridView runat="server" ID="dgvFabricante" DataKeyNames="Id" CssClass="  table table-striped table-bordered table-hover table-primary table table-bordered border-primary" AutoGenerateColumns="false">
                                            <Columns>
